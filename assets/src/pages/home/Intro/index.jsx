        ...
        <section>
          ...
          <div className="grid grid-cols-2 h-full w-full">
            ...
            <div className=" flex flex-col justify-center p-28 bg-zinc-900 text-white">
              ...
              <div className="p-4">
                <button class=" flex mx-auto  text-white bg-teal-500 border-0 py-2 px-5 focus:outline-none hover:bg-teal-600 rounded">
                  Let's Go
                </button>
              </div>
            </div>
          ...
          <Parallax className="p-10">
            <div
              className="bg-center"
              style={{
                backgroundImage: `url("/images/image14.jpg")`,
                width: "",
                height: "300px",
                backgroundRepeat: "no-repeat",
              }}
