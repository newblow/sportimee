...
const Intro = () => {
  ...
  <div class="container px-5 py-36 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-white">Choisisser votre formule</h1>
      ...
      <div class="flex mx-auto border-2 border-teal-500 rounded overflow-hidden mt-6">
        <button class="py-1 px-4 bg-teal-500 text-white focus:outline-none">Monthly</button>
    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden hover:border-teal-400">
          <h2 class="text-sm tracking-widest text-gray-400 title-font mb-1 font-medium">DECOUVERTE</h2>
          <h1 class="text-5xl pb-4 mb-4 border-b border-gray-800 leading-none">Free</h1>
          ...
          <button class="flex items-center mt-auto text-white bg-gray-800 border-0 py-2 px-4 w-full focus:outline-none hover:bg-teal-500 rounded ">Ma formule
      ...
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full ">
        <div class="h-full p-6 rounded-lg border-2 border-gray-500 flex flex-col relative overflow-hidden hover:border-teal-500">
          <span class="bg-teal-500 text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">BON PLAN</span>
          <h2 class="text-sm tracking-widest text-gray-400 title-font mb-1 font-medium">RELAX</h2>
          <h1 class="text-5xl text-white leading-none flex items-center pb-4 mb-4 border-b border-gray-800">
            <span>$25</span>
            <span class="text-lg ml-1 font-normal text-gray-400">/mois</span>
          </h1>
          <p class="flex items-center text-gray-400 mb-2">
            <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-800 text-gray-500 rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
          ...
          <button class="flex items-center mt-auto text-white bg-gray-800 border-0 py-2 px-4 w-full focus:outline-none hover:bg-teal-600 rounded">Choisir
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </button>
      ...
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden hover:border-teal-500">
          <h2 class="text-sm tracking-widest text-gray-400 title-font mb-1 font-medium">SPORTIF</h2>
          <h1 class="text-5xl text-white leading-none flex items-center pb-4 mb-4 border-b border-gray-800">
            <span>$50</span>
            <span class="text-lg ml-1 font-normal text-gray-400">/mois</span>
          </h1>
          ...
          <button class="flex items-center mt-auto text-white bg-gray-800 border-0 py-2 px-4 w-full focus:outline-none rounded hover:bg-teal-500">Choisir
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </button>
      ...
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full ">
        <div class="h-full p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden hover:border-teal-500">
          <h2 class="text-sm tracking-widest text-gray-400 title-font mb-1 font-medium">EXPERT</h2>
          <h1 class="text-5xl text-white leading-none flex items-center pb-4 mb-4 border-b border-gray-800">
            <span>$70</span>
            <span class="text-lg ml-1 font-normal text-gray-400">/mois</span>
          </h1>
          ...
          <button class="flex items-center mt-auto text-white bg-gray-800 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-700 rounded">Choisir
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </button>
